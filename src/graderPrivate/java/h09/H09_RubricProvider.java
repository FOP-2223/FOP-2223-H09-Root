...
public class H09_RubricProvider implements RubricProvider {
    ...
    public static final Criterion H3_1_2 = Criterion.builder()
        ...
        .grader(Grader.testAwareBuilder()
            .requirePass(JUnitTestRef.ofClass(() -> ArraySequenceBasicTest.class))
            .requirePass(JUnitTestRef.ofClass(() -> ArraySequenceAdvancedTest.class))
            .pointsPassedMax()
            .pointsFailedMin()
            .build())
        .build();
    ...
    public static final Criterion H4_1_3 = createCriterion(
        "FilteringSequence ist vollständig korrekt implementiert.",
        () -> FilteringSequenceAdvancedTest.class);
